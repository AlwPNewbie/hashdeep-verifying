...
# Recursive mode
hashdeep -r Andriod-AppOriginal > original-results.txt
...
# Recursive mode
hashdeep -r Andriod-AppDuplicate > second-results.txt
# Verifying checksum
hashdeep -c sha1 -r -o f * > second-results-verified.txt
sort second-results-verified.txt > second-results-sorted.txt

diff original-results-sorted.txt second-results-sorted.txt > differnce.txt
...
# To perform an audit
hashdeep -r -a -k original-results.txt Andriod-AppDuplicate      # test the audit